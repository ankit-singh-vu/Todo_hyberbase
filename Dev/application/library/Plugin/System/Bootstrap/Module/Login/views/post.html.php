                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 d-flex align-items-center justify-content-center" style="background: #d5d5d5;">
                    <div class="sign-wrapper pd-l-0">
                        <div class="wd-100p mg-l-0">
                            <h3 class="tx-color-01 mg-b-5">Password reset mail Sent</h3>
                            <p class="tx-color-01 tx-18 mg-b-20">We have send you an email with a link to reset your password.
                                Open the password reset link, and following the instructions.</p>
                            <?php if (isset($error)) { ?>
