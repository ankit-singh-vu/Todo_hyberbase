...
class Datagrid extends Template
{
    ...
    public function noData($callback)
    {
        ...
        if(!is_callable($callback)) {
            throw new \System\View\Exception("noData content must be defined by using a closure or valid callback");
        }
    ...
    public function column($name, $callback)
    {
        // Check callback
        if(!is_callable($callback)) {
            throw new \System\View\Exception("Column must be defined by using a closure or callback");
        }
