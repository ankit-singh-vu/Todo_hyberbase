...
<div class="row row-xs">
    ...
    <div class="col-lg-8 col-xl-7 mg-t-10">
        <div class="card">
            <div class="
                    ...
                    justify-content-between
                  ">
                <h6 class="mg-b-0">Recurring Social Media Campaigns</h6>
                <ul class="
                      list-inline
                      d-flex
                      mg-t-20 mg-sm-t-10 mg-md-t-0 mg-b-0
                    ">
    ...
    <div class="col-lg-4 col-xl-5 mg-t-10">
        <div class="card">
            <div class="card-header pd-t-20 pd-b-0 bd-b-0">
                <h6 class="mg-b-5">User Interactions</h6>
            ...
            <div class="card-body pd-20">
                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <p class="
                          tx-11 tx-uppercase tx-spacing-1 tx-semibold
                          mg-b-10
                          tx-primary
                        ">
                            Expansions
    ...
    <div class="col-md-6 col-xl-4 mg-t-10 order-md-1 order-xl-0">
        <div class="card ht-lg-100p">
            <div class="
                    ...
                    justify-content-between
                  ">
                <h6 class="mg-b-0">Lead Revenue</h6>
                <div class="tx-13 d-flex align-items-center">
                    <span class="mg-r-5">Country:</span>
                    <a href="" class="d-flex align-items-center link-03 lh-0">USA <i class="icon ion-ios-arrow-down mg-l-5"></i></a>
                </div>
            </div>
            <!-- card-header -->
    ...
    <div class="col-lg-12 col-xl-8 mg-t-10">
        <div class="card mg-b-10">
            <div class="
                  ...
                  ">
                <div>
                    <h6 class="mg-b-5">Your Recent Leads</h6>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="tx-medium text-right">
                                $28,670.90
                                <span class="mg-l-5 tx-10 tx-normal tx-success"><i class="icon ion-md-arrow-up"></i> 4.5%</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="tx-medium text-right">
                                $26,930.40
                                <span class="mg-l-5 tx-10 tx-normal tx-danger"><i class="icon ion-md-arrow-down"></i> 0.8%</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="tx-color-03 tx-normal">03/04/2018</td>
        ...
        <div class="card card-body ht-lg-100">
            <div class="media">
                ...
                <div class="media-body mg-l-20">
                    <h6 class="mg-b-10">
                        Download your Lead details in CSV format.
                    </h6>
    ...
    <div class="col-md-6 col-xl-4 mg-t-10">
        <div class="card ht-100p">
            ...
            <div class="card-footer text-center tx-13">
                <a href="" class="link-03">View All Transactions
                    <i class="icon ion-md-arrow-down mg-l-5"></i></a>
            </div>
            <!-- card-footer -->
        </div>
        <!-- card -->
    ...
    <div class="col-md-6 col-xl-4 mg-t-10">
        <div class="card ht-100p">
            ...
            <div class="card-footer text-center tx-13">
                <a href="" class="link-03">View More Customers
                    <i class="icon ion-md-arrow-down mg-l-5"></i></a>
            </div>
            <!-- card-footer -->
        </div>
                ...
                <div class="row mg-b-20">
                    <div class="col">
                        <h5 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">
                            $150,200
                            <small class="tx-11 tx-success letter-spacing--2"><i class="icon ion-md-arrow-up"></i> 0.20%</small>
                        </h5>
                        <p class="
                          tx-10 tx-uppercase tx-spacing-1 tx-medium tx-color-03
                        ">
                            Total Sales
                        </p>
                    </div>
                    <div class="col">
                        <h5 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">
                            $21,880
                            <small class="tx-11 tx-danger letter-spacing--2"><i class="icon ion-md-arrow-down"></i> 1.04%</small>
                        </h5>
                        <p class="
                          tx-10 tx-uppercase tx-spacing-1 tx-medium tx-color-03
                        ">
