...
(function () {
  ...
  HTMLString.String = (function () {
    ...
    String.prototype.concat = function () {
      ...
      if (
        !(
          typeof inheritFormat === "undefined" ||
    ...
    String.prototype.endsWith = function (substring) {
      ...
      if (typeof substring === "string") {
        return (
          substring === "" || this.text().slice(-substring.length) === substring
        );
      }
...
(function () {
  ...
  ContentSelect.Range = (function () {
    ...
    Range.prototype.eq = function (range) {
      return (
        this.get()[0] === range.get()[0] && this.get()[1] === range.get()[1]
      );
    };
    ...
    Range.prototype.select = function (element) {
      ...
      (_ref = _getChildNodeAndOffset(element, this._from)),
        (startNode = _ref[0]),
        (startOffset = _ref[1]);
      (_ref1 = _getChildNodeAndOffset(element, this._to)),
        (endNode = _ref1[0]),
        (endOffset = _ref1[1]);
    ...
    Range.query = function (element) {
      ...
      (_ref = _getNodeRange(element, docRange)),
        (startNode = _ref[0]),
        (startOffset = _ref[1]),
        (endNode = _ref[2]),
        (endOffset = _ref[3]);
    ...
    while (childStack.length > 0) {
      ...
      switch (childNode.nodeType) {
        ...
        case Node.ELEMENT_NODE:
          if (
            ((_ref = childNode.nodeName.toLowerCase()),
            __indexOf.call(SELF_CLOSING_NODE_NAMES, _ref) >= 0)
          ) {
            if (childOffset === 0) {
              return [childNode, 0];
            } else {
  ...
  _getOffsetOfChildNode = function (parentNode, childNode) {
    ...
    while (childStack.length > 0) {
      ...
      if (otherChildNode === childNode) {
        if (
          ((_ref = otherChildNode.nodeName.toLowerCase()),
          __indexOf.call(SELF_CLOSING_NODE_NAMES, _ref) >= 0)
        ) {
          return offset + 1;
        }
      ...
      switch (otherChildNode.nodeType) {
        ...
        case Node.ELEMENT_NODE:
          if (
            ((_ref1 = otherChildNode.nodeName.toLowerCase()),
            __indexOf.call(SELF_CLOSING_NODE_NAMES, _ref1) >= 0)
          ) {
            offset += 1;
          } else {
  ...
  _getNodeRange = function (element, docRange) {
    ...
    if (startNode === element) {
      ...
      for (i = _i = 0, _len = childNodes.length; _i < _len; i = ++_i) {
        ...
        if (
          ((_ref = startNode.nodeName.toLowerCase),
          __indexOf.call(SELF_CLOSING_NODE_NAMES, _ref) >= 0)
        ) {
          startOffset = 1;
        }
...
(function () {
  ...
  ContentEdit = {
    ...
    _: function (s) {
      ...
      if (
        ContentEdit._translations[lang] &&
  ...
  _TagNames = (function () {
    ...
    _TagNames.prototype.register = function () {
      ...
      (cls = arguments[0]),
        (tagNames = 2 <= arguments.length ? __slice.call(arguments, 1) : []);
      _results = [];
  ...
  ContentEdit.Node = (function () {
    ...
    Node.prototype.trigger = function () {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(
          callback.call.apply(callback, [this].concat(__slice.call(args)))
        );
      }
      return _results;
    };
  ...
  ContentEdit.Element = (function (_super) {
    ...
    Element.prototype.mount = function () {
      ...
      if (sibling) {
        this.parent()
          .domElement()
          .insertBefore(this._domElement, sibling.domElement());
      } else {
        if (this.isFixed()) {
          this.parent()
            .domElement()
    ...
    Element.prototype._addDOMEventListeners = function () {
      ...
      for (eventName in _ref) {
        ...
        _results.push(
          this._domElement.addEventListener(eventName, eventHandler)
        );
      }
      return _results;
    };
    ...
    Element.prototype._onOver = function (ev) {
      ...
      if (
        !(
          this.constructor.droppers[dragging.type()] ||
    ...
    Element.prototype._removeDOMEventListeners = function () {
      ...
      for (eventName in _ref) {
        eventHandler = _ref[eventName];
        _results.push(
          this._domElement.removeEventListener(eventName, eventHandler)
        );
      }
      return _results;
    };
  ...
  ContentEdit.ResizableElement = (function (_super) {
    ...
    ResizableElement.prototype.size = function (newSize) {
      ...
      if (this.isMounted()) {
        ...
        return this._domElement.setAttribute(
          "data-ce-size",
          this._getSizeInfo()
        );
      }
    ...
    ResizableElement.prototype._onMouseMove = function (ev) {
      ...
      corner = this._getResizeCorner(ev.clientX, ev.clientY);
      if (corner) {
        return this._addCSSClass(
          "ce-element--resize-" + corner[0] + "-" + corner[1]
        );
      }
    };
  ...
  _Root = (function (_super) {
    ...
    _Root.prototype._onDrag = function (ev) {
      ...
      if (this._dropTarget) {
        ...
        if (
          ((_ref = placement[0]),
          __indexOf.call(this._dragging.constructor.placements, _ref) >= 0)
        ) {
          this._dropTarget._addCSSClass("ce-element--drop-" + placement[0]);
        }
        if (
          ((_ref1 = placement[1]),
          __indexOf.call(this._dragging.constructor.placements, _ref1) >= 0)
        ) {
          return this._dropTarget._addCSSClass(
            "ce-element--drop-" + placement[1]
          );
        }
      }
    };
  ...
  ContentEdit.Static = (function (_super) {
    ...
    Static.prototype.html = function (indent) {
      ...
      if (HTMLString.Tag.SELF_CLOSING[this._tagName]) {
        return (
          "" + indent + "<" + this._tagName + this._attributesToString() + ">"
        );
      }
      return (
        "" +
  ...
  ContentEdit.Text = (function (_super) {
    ...
    Text.prototype._onMouseDown = function (ev) {
      ...
      if (
        ...
        ContentEdit.Root.get().focused() === this
      ) {
        ev.preventDefault();
  ...
  ContentEdit.ListItem = (function (_super) {
    ...
    ListItem.prototype.unindent = function () {
      ...
      if (grandParent.type() === "ListItem") {
        ...
        grandParent
          .parent()
          .attach(this, grandParent.parent().children.indexOf(grandParent) + 1);
    ...
    ListItem.fromDOMElement = function (domElement) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (childNode.nodeType === 1) {
          if (
            (_ref1 = childNode.tagName.toLowerCase()) === "ul" ||
            _ref1 === "ol" ||
            _ref1 === "li"
          ) {
            if (!listDOMElement) {
      ...
      initDrag = (function (_this) {
        return function () {
          ...
          if (ContentEdit.Root.get().dragging() === _this) {
            ...
            return (_this._dragTimeout = setTimeout(
              initDrag,
...
(function () {
    ...
    WidgetUI.prototype.hide = function () {
      ...
      monitorForHidden = (function (_this) {
        return function () {
          ...
          if (
            parseFloat(window.getComputedStyle(_this._domElement).opacity) <
            0.01
          ) {
  ...
  ContentTools.FlashUI = (function (_super) {
    ...
    FlashUI.prototype.mount = function (modifier) {
      ...
      FlashUI.__super__.mount.call(
        this,
        ContentTools.EditorApp.get().domElement()
      );
      monitorForHidden = (function (_this) {
        return function () {
          if (!window.getComputedStyle) {
  ...
  ContentTools.IgnitionUI = (function (_super) {
    ...
    IgnitionUI.prototype.mount = function () {
      ...
      //this._domEdit = this.constructor.createDiv(['ct-ignition__button', 'ct-ignition__button--addblock']);
      //this._domElement.appendChild(this._domEdit);
    ...
    IgnitionUI.prototype._addDOMEventListeners = function () {
      ...
      return this._domCancel.addEventListener(
        "click",
        (function (_this) {
          return function (ev) {
            ev.preventDefault();
  ...
  ContentTools.InspectorUI = (function (_super) {
    ...
    InspectorUI.prototype.updateCounter = function () {
      ...
      return (this._domCounter.textContent =
        "" + word_count + " / " + line + ":" + column);
    };
    ...
    InspectorUI.prototype.updateTags = function () {
      ...
      for (_j = 0, _len1 = elements.length; _j < _len1; _j++) {
        element = elements[_j];
        if (
          ContentTools.INSPECTOR_IGNORED_ELEMENTS.indexOf(element.type()) !== -1
        ) {
          continue;
        }
  ...
  ContentTools.ToolboxUI = (function (_super) {
        ...
        _results.push(
          function () {
            ...
            for (_j = 0, _len1 = toolGroup.length; _j < _len1; _j++) {
              ...
              _results1.push(
                this._toolUIs[toolName].addEventListener(
                  "applied",
                  (function (_this) {
                    return function () {
      ...
      this._handleKeyDown = (function (_this) {
        return function (ev) {
          ...
          if (element && !element.content) {
            if (ev.keyCode === 46) {
              ev.preventDefault();
              return ContentTools.Tools.Remove.apply(
                element,
                null,
                function () {}
              );
    ...
    ToolboxUI.prototype._onDrag = function (ev) {
      ContentSelect.Range.unselectAll();
      this._domElement.style.left =
        "" + (ev.clientX - this._draggingOffset.x) + "px";
      return (this._domElement.style.top =
        "" + (ev.clientY - this._draggingOffset.y) + "px");
    };
  ...
  ContentTools.DialogUI = (function (_super) {
    ...
    DialogUI.prototype._addDOMEventListeners = function () {
      ...
      return this._domClose.addEventListener(
        "click",
        (function (_this) {
          return function (ev) {
            ev.preventDefault();
    ...
    ImageDialog.prototype._addDOMEventListeners = function () {
        ...
        (function (_this) {
          return function (ev) {
            ...
            return _this.dispatchEvent(
              _this.createEvent("imageuploader.fileready", {
                file: file,
              })
            );
          };
      ...
      this._domCancelUpload.addEventListener(
        ...
        (function (_this) {
          return function (ev) {
            return _this.dispatchEvent(
              _this.createEvent("imageuploader.cancelupload")
            );
          };
        })(this)
      );
      this._domClear.addEventListener(
        ...
        (function (_this) {
          return function (ev) {
            ...
            return _this.dispatchEvent(
              _this.createEvent("imageuploader.clear")
            );
          };
        })(this)
      );
      this._domRotateCCW.addEventListener(
        ...
        (function (_this) {
          return function (ev) {
            _this.removeCropMarks();
            return _this.dispatchEvent(
              _this.createEvent("imageuploader.rotateccw")
            );
          };
        })(this)
      );
      this._domRotateCW.addEventListener(
        ...
        (function (_this) {
          return function (ev) {
            _this.removeCropMarks();
            return _this.dispatchEvent(
              _this.createEvent("imageuploader.rotatecw")
            );
          };
        })(this)
      );
      ...
      return this._domInsert.addEventListener(
        "click",
        (function (_this) {
          return function (ev) {
  ...
  CropMarksUI = (function (_super) {
    ...
    CropMarksUI.prototype._addDOMEventListeners = function () {
      ...
      return this._domHandles[1].addEventListener(
        "mousedown",
        (function (_this) {
          return function (ev) {
            if (ev.button === 0) {
    ...
    CropMarksUI.prototype._drag = function (top, left) {
      ...
      return (this._domRulers[this._dragging].style.left =
        "" + offsetLeft + "px");
    };
  ...
  ContentTools.LinkDialog = (function (_super) {
    ...
    LinkDialog.prototype._addDOMEventListeners = function () {
      ...
      return this._domButton.addEventListener(
        "click",
        (function (_this) {
          return function (ev) {
            ev.preventDefault();
  ...
  ContentTools.PropertiesDialog = (function (_super) {
    ...
    PropertiesDialog.prototype.caption = function (caption) {
      ...
      this._caption = caption;
      return (this._domCaption.textContent =
        ContentEdit._(caption) + (": " + this.element.tagName()));
    };
    ...
    PropertiesDialog.prototype.mount = function () {
      ...
      domTabs = this.constructor.createDiv([
        "ct-control-group",
        "ct-control-group--left",
      ]);
    ...
    PropertiesDialog.prototype._addDOMEventListeners = function () {
      ...
      return this._domApply.addEventListener(
        "click",
        (function (_this) {
          return function (ev) {
            var cssClass;
  ...
  AttributeUI = (function (_super) {
    ...
    AttributeUI.prototype._addDOMEventListeners = function () {
      ...
      return this._domValue.addEventListener(
        "keydown",
        (function (_this) {
          return function (ev) {
  ...
  ContentTools.TableDialog = (function (_super) {
    ...
    TableDialog.prototype.mount = function () {
      ...
      domControlGroup = this.constructor.createDiv([
        "ct-control-group",
        "ct-control-group--right",
      ]);
      ...
      this._domInput.addEventListener(
        ...
        (function (_this) {
          return function (ev) {
            ...
            return (_this._updatePreviewTimeout = setTimeout(
              updatePreview,
              500
            ));
          };
  ...
  ContentTools.HTMLCleaner = (function () {
    ...
    HTMLCleaner.DEFAULT_TAG_WHITELIST = [
      "a",
      "address",
      "b",
      "blockquote",
    ...
    function HTMLCleaner(tagWhitelist, attributeWhitelist) {
      this.tagWhitelist =
        tagWhitelist || this.constructor.DEFAULT_TAG_WHITELIST;
      this.attributeWhitelist =
        attributeWhitelist || this.constructor.DEFAULT_ATTRIBUTE_WHITELIST;
    }
  ...
  _EditorApp = (function (_super) {
    ...
    _EditorApp.prototype.init = function (
      queryOrDOMElements,
      namingProp,
      fixtureTest,
      withIgnition
    ...
    _EditorApp.prototype.pasteHTML = function (element, content) {
      ...
      if (
        element.isFixed() ||
        (inlineTags.indexOf(firstNode) > -1 &&
        ...
        if (element.content) {
          ...
          if (replaced.length()) {
            ...
            if (tags.length >= 1) {
              content = content.format.apply(
                content,
                [0, content.length()].concat(__slice.call(tags))
              );
            }
          }
    ...
    _EditorApp.prototype.pasteText = function (element, content) {
      ...
      if (spawn) {
        console.log("asdasdasdadadadjahjdhakasd");
    ...
    _EditorApp.prototype.revert = function () {
      ...
      if (ContentTools.CANCEL_MESSAGE) {
        ...
        if (
          ContentEdit.Root.get().lastModified() > this._rootLastModified &&
    ...
    _EditorApp.prototype.revertToSnapshot = function (
      snapshot,
      restoreEditable
    ) {
      var child,
    ...
    _EditorApp.prototype.syncRegions = function (regionQuery, restoring) {
      ...
      if (this._regionQuery) {
        if (
          typeof this._regionQuery === "string" ||
    ...
    _EditorApp.prototype._initRegions = function (restoring) {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        if (
          this._regions[name] &&
          this._regions[name].domElement() === domRegion
        ) {
          continue;
        }
  ...
  ContentTools.Tool = (function () {
    ...
    Tool.dispatchEditorEvent = function (name, detail) {
      return this.editor().dispatchEvent(
        this.editor().createEvent(name, detail)
      );
    };
  ...
  ContentTools.Tools.Link = (function (_super) {
    ...
    Link.isApplied = function (element, selection) {
      if (element.type() === "Image") {
        ...
        return Link.__super__.constructor.isApplied.call(
          this,
          element,
          selection
        );
    ...
    Link.apply = function (element, selection, callback) {
      ...
      (_ref1 = ContentTools.getScrollPosition()),
        (scrollX = _ref1[0]),
        (scrollY = _ref1[1]);
      dialog.position([
  ...
  ContentTools.Tools.Paragraph = (function (_super) {
    ...
    Paragraph.apply = function (element, selection, callback) {
      ...
      if (ContentTools.Tools.Heading.canApply(element) && !forceAdd) {
        return Paragraph.__super__.constructor.apply.call(
          this,
          element,
          selection,
          callback
  ...
  ContentTools.Tools.AlignLeft = (function (_super) {
    ...
    AlignLeft.isApplied = function (element, selection) {
      ...
      if (
        (_ref = element.type()) === "ListItemText" ||
        _ref === "TableCellText"
      ) {
  ...
  ContentTools.Tools.UnorderedList = (function (_super) {
    ...
    UnorderedList.canApply = function (element, selection) {
      ...
      return (
        element.content !== void 0 &&
        ((_ref = element.parent().type()) === "Region" || _ref === "ListItem")
      );
    };
  ...
  ContentTools.Tools.Table = (function (_super) {
    ...
    Table._createTableSection = function (sectionTag, cellTag, columns) {
      ...
      for (
        i = _i = 0;
        0 <= columns ? _i < columns : _i > columns;
        i = 0 <= columns ? ++_i : --_i
      ) {
        cell = new ContentEdit.TableCell(cellTag);
        row.attach(cell);
