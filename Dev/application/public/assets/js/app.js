...
$(function(){
    ...
    SingAppView.prototype.collapseNavigation = function(){
        ...
        //alert('Collaps');
        //$('.full-logo').fadeOut(function() {
        //    $('.short-logo').fadeIn();
        //});

        if(!$('body').hasClass('nav-static')) {
            //$('.full-logo').hide();
            //$('.short-logo').show();
            $('.full-logo').fadeOut(function() {
                $('.short-logo').fadeIn(function() {
    ...
    SingAppView.prototype._checkLoading = function(e){
        var oldLoading = false; //this.loading;
    ...
    SingAppView.prototype._logErrors = function(){
        ...
        //@todo: Notify JS error to server Notification module to be mailed to dev team
    };
